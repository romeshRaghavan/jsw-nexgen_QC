...
try{
 var s = "<li>"
 		+"<input id = 'tripDate_"+i +"' type=button value="+tripDate+" onclick ='fetchTripDetails("+ i +","+requestTripId+");'>"
        +"</li>";
...
var options = "<li class='airplan'>"
			...
			+"<span class='pull-left tripreficon'><input id ='bookingPriority_"+i+"' type='text' value='0' class='selectpreftxt' onkeyUp='validateBookingPriority("+i+"); '></span>"
			+"<div class='pull-left triprefblock'>"
			+"<table class='uptripstxttable'>"
